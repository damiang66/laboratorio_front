...
import { height } from "@fortawesome/free-solid-svg-icons/faHouseCircleCheck";
        ...
        <Routes>
          ...
          {!login.isAdmin || (
            <>
              ...
              <Route
                path="certificados/registrar"
                element={<CertificadoRegistroPage />}
              />
              <Route path="certificados" element={<CertificadoListPage />} />
              <Route
                path="certificados/editar/:id"
                element={<CertificadoRegistroPage />}
              />
              <Route path="certificados/imprimir/:id" element={<PDFViewer />} />
              <Route
                path="certificados/cliente/:clienteId"
                element={<CertificadoRegistroPage />}
              />
